...
export const interfaceLangs = {
    tj: {
        ...
        group: {
            ...
            attendanceEditDeadlineExceeded: "Шумо наметавонед маълумоти зиёда аз 3 рӯз пешро таҳрир кунед.",
            loading: "Сарборӣ...",
    ...
    en: {
        ...
        group: {
            ...
            attendanceEditDeadlineExceeded: "You cannot edit data older than 3 days.",
            loading: "Loading...",
    ...
    kr: {
        ...
        group: {
            ...
            attendanceEditDeadlineExceeded: "3일 이상 경과한 데이터는 수정할 수 없습니다.",
            loading: "로딩 중...",
